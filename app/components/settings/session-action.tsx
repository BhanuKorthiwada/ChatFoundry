      ...
      <AlertDialogContent className="sm:max-w-md">
        <div className="flex flex-col gap-2 max-sm:items-center sm:flex-row sm:gap-4">
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to sign out of other sessions? This will sign you out of all sessions except the
              current one.
            </AlertDialogDescription>
          </AlertDialogHeader>
        </div>
        <fetcher.Form method="post" action=".">
          <AlertDialogFooter>
            ...
            <LoadingButton buttonText="Sign out" loadingText="Signing out..." isPending={isPending} />
          </AlertDialogFooter>
        </fetcher.Form>
      </AlertDialogContent>
    </AlertDialog>
