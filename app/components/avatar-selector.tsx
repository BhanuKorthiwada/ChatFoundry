...
export function AvatarSelector({ avatarUrl, placeholderUrl }: { avatarUrl: string | null; placeholderUrl: string }) {
  ...
  return (
    <div className="relative flex size-24 overflow-hidden rounded-full bg-muted">
      <img src={previewUrl || placeholderUrl} alt="Current avatar" className="size-full object-cover" />
